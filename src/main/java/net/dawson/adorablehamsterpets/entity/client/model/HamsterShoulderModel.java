...
public class HamsterShoulderModel extends EntityModel<AbstractClientPlayerEntity> {
    ...
    public HamsterShoulderModel(ModelPart root) {
        ...
        // Get references to cheek parts using the NEW hierarchy
        try {
            ...
            // Optional: Get other parts if needed
            // this.closed_eyes = this.root.getChild("root").getChild("body").getChild("head_parent").getChild("head_child").getChild("closed_eyes");
            // this.nose = this.root.getChild("root").getChild("body").getChild("head_parent").getChild("head_child").getChild("nose");
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        // --- UPDATED: left_ear cube definition ---
        ...
        // --- UPDATED: right_ear cube definition ---
        ...
        // Deflated Cheeks (Unchanged definition)
        ...
        // --- UPDATED: left_cheek_inflated cube definition ---
        ...
        // --- UPDATED: right_cheek_inflated cube definition ---
        ...
        // --- UPDATED: closed_eyes definition ---
        ...
        // Hands and Legs (Unchanged definitions)
