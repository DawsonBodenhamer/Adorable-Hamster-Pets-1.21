...
//
//public class HamsterGeoModel extends GeoModel<HamsterEntity> {
//
//    private final ResourceLocation model = new ResourceLocation(AdorableHamsterPets.MOD_ID, "geo/hamster.geo.json");
//    private final ResourceLocation texture = new ResourceLocation(AdorableHamsterPets.MOD_ID, ":textures/entity/hamster/default.png");
//    private final ResourceLocation animations = new ResourceLocation(AdorableHamsterPets.MOD_ID, ":animations/anim_hamster.json");
//
//
//    @Override
//    public ResourceLocation getModelLocation(HamsterEntity hamster) {
