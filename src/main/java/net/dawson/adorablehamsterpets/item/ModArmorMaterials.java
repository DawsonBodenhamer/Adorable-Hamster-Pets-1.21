    ...
    public static final RegistryEntry<ArmorMaterial> PINK_GARNET_ARMOR_MATERIAL = registerArmorMaterial("pink_garnet",
            () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
                ...
                map.put(ArmorItem.Type.BODY, 4);
                    ...
                    List.of(new ArmorMaterial.Layer(Identifier.of(AdorableHamsterPets.MOD_ID, "pink_garnet"))), 0, 0));

    public static RegistryEntry<ArmorMaterial> registerArmorMaterial(String name, Supplier<ArmorMaterial> material) {
        return Registry.registerReference(Registries.ARMOR_MATERIAL, Identifier.of(AdorableHamsterPets.MOD_ID, name), material.get());
    }
}
